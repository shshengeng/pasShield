 ...
 */
export function base64EncodeByteArray(value) {
 ...
 * @param value - the Uint8Array to encode
 */
export function base64UrlEncodeByteArray(value) {
    // Buffer.from accepts <ArrayBuffer> | <SharedArrayBuffer>-- the TypeScript definition is off here
    // https://nodejs.org/api/buffer.html#buffer_class_method_buffer_from_arraybuffer_byteoffset_length
    const bufferValue = value instanceof Buffer ? value : Buffer.from(value.buffer);
 ...
 */
export function base64DecodeString(value) {
...
export function hexToByteArray(value) {
    if (value.length % 2 !== 0) {
...
export function byteArrayToHex(value) {
